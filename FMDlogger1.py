...
def preProcess(crop):
    ...
    resize = cv2.resize(backtorgb, (224, 224))
...
#----------------- This code was used to load my face detection trained model---------------
...
with open("labels.pickle", 'rb') as f:##
    ...
    print(labels)
#----------------------- You can neglect the code above ----------------------------
        ...
        if confidence > 0.5:
            ...
            if label == "No Mask Detected":
                if label == prev_label:
                    ...
                    try:
                        cv2.putText(frame, "Person Identified: " + recog, (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.6, color, 2)
                        if flag == 0:
